const initialCards = [
  {
    name: "Val Thorens",
    link: "httphttps://practicum-content.s3.us-west-1.amazonaws.com/software-engineer/spots/1-photo-by-moritz-feldmann-from-pexels.jpg",
  },
  {
...
function handleNewPostSubmit(evt) {
  evt.preventDefault();
  console.log("Image Link:", newPostImage.value);
